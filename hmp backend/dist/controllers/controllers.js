...
import { getProductByIdQuery, getProductsQuery, } from "../database/queries/productQueries.js";
...
export var getProducts = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, take, skip, result, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.query, take = _a.take, skip = _a.skip;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, getProductsQuery(take, skip)];
            case 2:
                result = _b.sent();
                res.json(result);
                return [3 /*break*/, 4];
...
export var getProductById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, getProductByIdQuery(id)];
            case 2:
                result = _a.sent();
                res.json(result);
                return [3 /*break*/, 4];
...
export var postOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, _i, data_1, product, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                data = req.body;
            ...
            case 2:
                ...
                return [4 /*yield*/, postOrderQuery(__assign({}, product))];
            case 3:
                // Insert each data object into the database
                _a.sent();
                _a.label = 4;
